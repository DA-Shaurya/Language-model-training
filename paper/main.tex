...
\title{Deep Learning-Based OCR for Devanagari (Marathi) Script: CRNN with Squeeze-and-Excitation Attention and CTC Decoding\thanks{Presented and Published at the Fourth International Conference on Innovative Computing and Cutting-edge Technologies (ICICCT 2026), Istanbul, Turkey.}}
\titlerunning{Deep Learning-Based OCR for Devanagari (Marathi) Script}

\author{Shaurya Singh\inst{1} \and Subroto Chandra\inst{1} \and Dr. Meenal Jabde\inst{1}\thanks{Corresponding author.} \and Dr. C. H. Patil\inst{1}\footnotemark[2]}
\authorrunning{S. Singh et al.}

\institute{School of Computer Science, Dr. Vishwanath Karad MIT World Peace University, Pune, India \\
